...
def show():
    ...
    if st.session_state.get("roadmap_result"):
        ...
        <div style="background:#FFFFFF; border-radius:16px; padding:32px;
             border:1px solid #E5E7EB; margin-bottom:24px; overflow-x:auto;">
            <div style="display:flex; align-items:center; gap:8px; margin-bottom:24px;">
                <div style="width:8px; height:8px; border-radius:50%; background:#02C39A;"></div>
                <span style="color:#02C39A; font-size:13px; font-weight:700;">{job} 취준 로드맵</span>
            </div>
            <div style="display:grid; grid-template-columns:120px 1fr 1fr 1fr 1fr; gap:2px; margin-bottom:4px;">
                <div style="background:#1C1C1E; padding:12px; border-radius:8px 0 0 0;">
                    <span style="color:#FFFFFF; font-size:12px; font-weight:700;">단계</span>
                </div>
                <div style="background:#1C1C1E; padding:12px; text-align:center;">
                ...
                <div style="background:#1C1C1E; padding:12px; text-align:center; border-radius:0 8px 0 0;">
            ...
            <div style="display:grid; grid-template-columns:120px 1fr 1fr 1fr 1fr; gap:2px; margin-bottom:2px;">
                <div style="background:#F9FAFB; padding:12px; display:flex; align-items:center;">
                    <span style="color:#111827; font-size:13px; font-weight:600;">자격증</span>
                </div>
                <div style="background:#F0FDF9; padding:12px; grid-column: span 2;">
                    <div style="background:#02C39A; border-radius:6px; padding:6px 12px;">
                        <span style="color:#FFF; font-size:11px; font-weight:600;">필수 자격증 취득</span>
                    </div>
                </div>
                <div style="background:#F9FAFB; padding:12px;">
                    <div style="background:#E5E7EB; border-radius:6px; padding:6px 12px;">
                        <span style="color:#6B7280; font-size:11px;">심화 자격증</span>
                    </div>
                </div>
                <div style="background:#F9FAFB; padding:12px;"></div>
            </div>
            <div style="display:grid; grid-template-columns:120px 1fr 1fr 1fr 1fr; gap:2px; margin-bottom:2px;">
                <div style="background:#F9FAFB; padding:12px; display:flex; align-items:center;">
                    <span style="color:#111827; font-size:13px; font-weight:600;">스킬</span>
                </div>
                <div style="background:#F9FAFB; padding:12px;">
                ...
                <div style="background:#F9FAFB; padding:12px; grid-column: span 2;">
            ...
            <div style="display:grid; grid-template-columns:120px 1fr 1fr 1fr 1fr; gap:2px; margin-bottom:2px;">
                <div style="background:#F9FAFB; padding:12px; display:flex; align-items:center;">
                    <span style="color:#111827; font-size:13px; font-weight:600;">경험</span>
                </div>
                <div style="background:#F9FAFB; padding:12px;"></div>
                <div style="background:#F9FAFB; padding:12px;">
            ...
            <div style="display:grid; grid-template-columns:120px 1fr 1fr 1fr 1fr; gap:2px;">
                <div style="background:#F9FAFB; padding:12px; display:flex; align-items:center; border-radius:0 0 0 8px;">
                    <span style="color:#111827; font-size:13px; font-weight:600;">취업준비</span>
                </div>
                <div style="background:#F9FAFB; padding:12px;"></div>
                <div style="background:#F9FAFB; padding:12px;"></div>
                <div style="background:#F9FAFB; padding:12px;">
                ...
                <div style="background:#F9FAFB; padding:12px; border-radius:0 0 8px 0;">
        ...
        <div style="background:#FFFFFF; border-radius:16px; padding:32px;
            ...
            <div style="display:flex; align-items:center; gap:8px; margin-bottom:24px;">
                <div style="width:8px; height:8px; border-radius:50%; background:#02C39A;"></div>
                <span style="color:#02C39A; font-size:13px; font-weight:700;">상세 로드맵</span>
            </div>
